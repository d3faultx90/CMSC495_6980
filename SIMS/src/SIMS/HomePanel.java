...
public class HomePanel extends javax.swing.JPanel {
	...
	// Refreshes all data so the GUI reflects the database's most current state
	private void refreshDataButtonActionPerformed(java.awt.event.ActionEvent evt) {
		try {
			...
			GeneralGuiFunctions.displayErrorPane("Failed to refresh database");
		}
	}

	// Sets the labels that display sales information 
	protected void setSaleLabels() {

		// Grabs all the dates required to populate the labels
        ...
        String salesYesterday = GeneralGuiFunctions.doubleToDollarRepresentation(GeneralGuiFunctions.parseSales(c.retrieveSalesOnDate(minusDay)));
        String salesThisWeek = GeneralGuiFunctions.doubleToDollarRepresentation(GeneralGuiFunctions.parseSales(c.retrieveSalesByDateRange(minusWeek, today)));
		...
		yesterdaysSalesLabel.setText("Yesterday's sales: " + salesYesterday);
		todaysSalesLastYearLabel.setText("Today's sales last year: " + salesLastYear);
		lastWeekSaleLabel.setText("Sales this week: " + salesThisWeek);
	...
	private void initComponents() {
		...
		headerPanelLayout.setHorizontalGroup(headerPanelLayout
				...
				.addGroup(headerPanelLayout.createSequentialGroup().addContainerGap().addComponent(helloUsernameLabel)
						.addGap(64, 64, 64).addComponent(currentDateLabel)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 86, Short.MAX_VALUE)
						.addComponent(currentTimeLabel).addGap(32, 32, 32)));
		headerPanelLayout.setVerticalGroup(headerPanelLayout
				...
				.addGroup(headerPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(headerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(helloUsernameLabel).addComponent(currentTimeLabel)
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				...
				.addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(todaysSalesLabel, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(todaysSalesLastYearLabel, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(yesterdaysSalesLabel, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(lastWeekSaleLabel, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(monthlySalesLabel, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(annualSalesLabel, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(totalRecordedSalesLabel, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(refreshDataButton, javax.swing.GroupLayout.PREFERRED_SIZE, 38,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(helpButton))
				.addGap(32, 32, 32).addComponent(todaysSalesLabel)
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
				.addComponent(todaysSalesLastYearLabel)
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(yesterdaysSalesLabel)
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(lastWeekSaleLabel)
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(monthlySalesLabel)
				.addGap(8, 8, 8).addComponent(annualSalesLabel)
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
				.addComponent(totalRecordedSalesLabel).addGap(18, 18, 18).addComponent(logoutButton,
